...
public class PlanosContratosPage
{
    ...
    /// </summary>
    /// <returns></returns>
    public PlanosContratosPage ValidarPlanoCriado(string contextoDeTeste)
    {
        if (Enum.TryParse(contextoDeTeste, out ClienteUpSell clientePro) && clientePro == ClienteUpSell.ClienteStart)
        {

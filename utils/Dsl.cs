...
public class Dsl
{
    ...
    public static void PreencherCalendariosInicioVigencia(IWebDriver webDriver, int quantidadeAvancarMeses)
    {
        ...
        EsperarVisibilidadeDoElemento(webDriver, GlobalVariables.AvancarMesesCalendarios);
        ...
        else if (quantidadeAvancarMeses > 0)
        {
            ...
            {
                Esperar();
                webDriver.FindElement(By.XPath(GlobalVariables.AvancarMesesCalendarios)).Click();
            }
